    ...
    <div className={`space-y-6 ${className}`}>
      ...
      {metrics && (
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
          {/* Memory Donut */}
          <div className="metric-card flex flex-col items-center justify-center min-h-[300px]">
            <DonutChart
              title="Memória RAM"
          ...
          {/* CPU Donut */}
          <div className="metric-card flex flex-col items-center justify-center min-h-[300px] md:col-span-2 xl:col-span-1">
            <DonutChart
              title="CPU Usage"
        ...
        <div className="metric-card">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="p-3 lg:p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg text-center">
              ...
              <div className="text-xs lg:text-sm text-gray-600 dark:text-gray-400">CPU</div>
            </div>
            <div className="p-3 lg:p-4 bg-green-50 dark:bg-green-900/20 rounded-lg text-center">
              ...
              <div className="text-xs lg:text-sm text-gray-600 dark:text-gray-400">Memória</div>
            </div>
            <div className="p-3 lg:p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg text-center">
              ...
              <div className="text-xs lg:text-sm text-gray-600 dark:text-gray-400">Disco</div>
            </div>
            <div className="p-3 lg:p-4 bg-amber-50 dark:bg-amber-900/20 rounded-lg text-center">
              ...
              <div className="text-xs lg:text-sm text-gray-600 dark:text-gray-400">MB/s Rede</div>
            </div>
          </div>
        </div>
      )}
