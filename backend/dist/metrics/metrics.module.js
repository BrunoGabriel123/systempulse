...
exports.MetricsModule = MetricsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [metrics_service_1.MetricsService, metrics_repository_1.MetricsRepository, metrics_collector_service_1.MetricsCollectorService],
        exports: [metrics_service_1.MetricsService, metrics_repository_1.MetricsRepository, metrics_collector_service_1.MetricsCollectorService],
    })
], MetricsModule);
